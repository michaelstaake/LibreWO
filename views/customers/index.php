        ...
        <div class="mt-3">
            ...
            <form id="createCustomerForm" action="<?= BASE_URL ?>/customers" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="tel" id="customer_phone" name="phone" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                </div>
